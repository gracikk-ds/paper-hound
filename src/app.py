...
from src.routes import health_endpoints, processor_endpoints  # noqa: F401
from src.routes.routers import processor_router, status_check_bp, storage_router
...
def create_app() -> FastAPI:
    ...
    """
    modules_to_inject = [processor_endpoints]
    init_app_container(modules_to_inject, settings)
